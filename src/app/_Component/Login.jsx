  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form class="mx-auto max-w-lg ">
      <div class="flex flex-col gap-4 p-4 md:p-8">
        ...
        <div>
          <label for="password" class="mb-2 inline-block text-sm text-teal-800 sm:text-base">Password</label>
        ...
        <button class="block rounded-lg bg-gray-700 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-teal-200 hover:text-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">Log in</button>
      ...
      <div class="flex items-center justify-center ">
        <p class="text-center text-sm text-white">Don't have an account? <a href="/Register" class="text-gray-200 transition duration-100 hover:text-teal-200 active:text-indigo-700">Register</a></p>
      </div>
    </form>
  </div>
</div>
