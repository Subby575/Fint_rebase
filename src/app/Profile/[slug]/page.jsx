...
const Page = () => {
  ...
  <div  className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <a href='/Leaderboard' className='text-white rounded-lg  bg-gray-600 px-6 py-2'>&lt; Back</a>
    {/* <!-- text - start --> */}
          ...
          <span  className="text-lg font-semibold text-gray-400 lg:text-xl">Growth</span>
            ...
            <div  className="card w-3/12">
                ...
                <div  className="actions ">
                    ...
                    <div  className=" my-2 p-3 rounded-2xl text-center text-md text-white bg-red-600"><button>Logout</button></div>
                </div>
