...
import Pie from '@/app/_Component/Analyt/Pie'
import Bar from '@/app/_Component/Analyt/Bar'
import Line from '@/app/_Component/Analyt/Line'
...
const Page = () => {
  ...
  <div  className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <a href={`/Path/${play}`} className='text-white rounded-lg  bg-gray-600 px-6 py-2'>&lt; Back</a>
    {/* <!-- text - start --> */}
    <div  className="mb-10 md:mb-16">
      <h2  className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Statistics</h2>

      <p  className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Your finance profile is your roadmap to financial success. Track savings, investments, expenses, and progress towards your goals with ease.</p>
    </div>
    {/* <!-- text - end --> */}

    <div  className="grid gap-6 sm:grid-cols-2">
      {/* <!-- product - start --> */}
      <a href="#"  className="group relative flex h-80 items-end overflow-hidden rounded-lg  p-4 shadow-lg mb-12">
        <Bar/>
        ...
        <div  className="relative flex flex-col">
          ...
          <span  className="text-lg font-semibold text-gray-400 lg:text-xl">(Last week)</span>
        </div>
      </a>
      {/* <!-- product - end -->

      <!-- product - start --> */}
      <a href="#"  className="group relative flex h-80 items-end overflow-hidden rounded-lg  p-4 shadow-lg">
        <Line/>
        
        <div  className="pointer-events-none absolute inset-0  via-transparent to-transparent opacity-50"></div>

        <div  className="relative flex flex-col">
          <span  className="text-gray-600 font-bold">Consistency</span>
          <span  className="text-lg font-semibold text-gray-400 lg:text-xl">(week)</span>
        </div>
      </a>
      {/* <!-- product - end --> */}
      <a href="#"  className="group relative flex h-80 items-end overflow-hidden rounded-lg  p-4 shadow-lg ml-12 mb-12">
        <Pie/>

        <div  className="pointer-events-none absolute inset-0  via-transparent to-transparent opacity-50"></div>

        <div  className="relative flex flex-col">
          <span  className="text-gray-600 font-bold">Modules</span>
          <span  className="text-lg font-semibold text-gray-400 lg:text-xl">Completed</span>
        </div>
      </a>
      <a href="#"  className="group relative flex h-80 items-end overflow-hidden rounded-lg  p-4 shadow-lg">
        <Stack/>
        ...
        <div  className="relative flex flex-col">
          ...
          <span  className="text-lg font-semibold text-gray-400 lg:text-xl">Growth</span>
        </div>
      </a>
    </div>
  </div>
